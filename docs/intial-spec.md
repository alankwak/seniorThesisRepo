*A copy of the initial project specification for CoTab. Not all information may be up to date.*
...
### Purpose
The purpose of this document is to outline the functional and non-functional requirements of my senior thesis project, which is a browser extension that allows users to share tabs between devices. The extension is designed to streamline the task of shared web browsing, when multiple users are using the web to accomplish a shared goal. 
